...
"""
    response = dict(blocks=[
        ...
        slack_ui.blocks.button_block("Fill form now", str(form.id), constants.FILL_FORM_NOW)
    ])
    requests.post(response_url, json.dumps(response))
